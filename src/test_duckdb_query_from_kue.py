...
async def test_chat_completions(
    ...
    with patch("src.routes.message_routes.get_openai_client") as mock_get_client:
        ...
        with sync_auth_client.websocket_connect(
            ...
            assert msg4["has_tool_calls"] == True
