		...
		starlight({
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						{ label: 'Making your first map', slug: 'getting-started-copy/making-your-first-map' },
						{ label: 'Connecting to a demo database', slug: 'getting-started-copy/connecting-to-demo-postgis' },
					],
				},
				{
					label: 'Guides',
